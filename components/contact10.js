                    ...
                    <span className="contact10-text18">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_74CWFv'),
                        }}
                      ></span>
                    </span>
                  </Fragment>
                ...
                {props.content1 ?? (
                  <Fragment>
                    <span className="contact10-text19">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_lyK8Co'),
                        }}
                      ></span>
                    </span>
                  </Fragment>
            ...
            <div className="contact10-container2">
                ...
                {props.location1 ?? (
                  <Fragment>
                    <span className="contact10-text20">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text__zP0de'),
                        }}
                      ></span>
                    </span>
                  </Fragment>
                ...
                {props.location1Description ?? (
                  <Fragment>
                    <span className="contact10-text21">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_dMP7ww'),
                        }}
                      ></span>
                    </span>
                  </Fragment>
              ...
              <div className="contact10-container3">
                ...
                >
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('text_FBnZz4'),
                    }}
                  ></span>
                </a>
              </div>
            ...
            <div className="contact10-container4">
                ...
                {props.location2 ?? (
                  <Fragment>
                    <span className="contact10-text17">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_KUpOHo'),
                        }}
                      ></span>
                    </span>
                  </Fragment>
                ...
                {props.location2Description ?? (
                  <Fragment>
                    <span className="contact10-text16">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_EIL6bE'),
                        }}
                      ></span>
                    </span>
                  </Fragment>
              ...
              <div className="contact10-container5">
                ...
                >
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('text_eCtBGM'),
                    }}
                  ></span>
                </a>
              </div>
