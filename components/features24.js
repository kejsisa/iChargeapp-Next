                      ...
                      <span className="features24-text1">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_8jva86'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.feature1Description ?? (
                    <Fragment>
                      <span className="features24-text5">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_xvoBH9'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.feature2Title ?? (
                    <Fragment>
                      <span className="features24-text2">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_3AWdHZ'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.feature2Description ?? (
                    <Fragment>
                      <span className="features24-text6">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_DbggSm'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.feature3Title ?? (
                    <Fragment>
                      <span className="features24-text4">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_FNni2N'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.feature3Description ?? (
                    <Fragment>
                      <span className="features24-text3">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_zf0txM'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
